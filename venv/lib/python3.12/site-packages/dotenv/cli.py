...
def enumerate_env() -> Optional[str]:
    """
    Return a path for the ${pwd}/.env.dev file.
...
@click.option(
    ...
    help="Location of the .env.dev file, defaults to .env.dev file in current working directory.",
)
@click.option(
    "-q",
    "--quote",
...
def cli(ctx: click.Context, file: Any, quote: Any, export: Any) -> None:
    """This script is used to set, get or unset values from a .env.dev file."""
...
@click.option(
    ...
    default=True,
    help="Override variables from the environment file with those from the .env.dev file.",
)
